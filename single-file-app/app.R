...
ui <- fluidPage(
  ...
  # app title ---
  tags$h1("My App Title"), # highlight + Shift + 9 for wrapping text in parentheses
  
  # app subtitle ---
  h2(strong("Exploring Antartic Penguin Data")),
